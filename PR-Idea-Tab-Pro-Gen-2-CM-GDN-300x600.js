...
lib.ssMetadata = [
		{name:"PR_Idea_Tab_Pro_Gen_2_CM_GDN_300x600_atlas_1", frames: [[1208,602,50,50],[0,0,300,600],[302,0,300,600],[604,0,300,600],[906,0,300,600],[1208,0,300,600],[1510,0,300,600],[0,602,300,600],[302,602,300,600],[604,602,300,600],[906,602,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Idea_Tab_Pro_Gen_2_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaTabProGen2CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Layer_10
	this.instance = new lib.Frame10();
	this.instance.setTransform(0,1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(405).to({_off:false},0).wait(45));

	// Layer_9
	this.instance_1 = new lib.Frame9();
	this.instance_1.setTransform(0,1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(361).to({_off:false},0).to({_off:true},44).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(315).to({_off:false},0).to({_off:true},46).wait(89));

	// Layer_7
	this.instance_3 = new lib.Frame7();
	this.instance_3.setTransform(0,1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(271).to({_off:false},0).to({_off:true},44).wait(135));

	// Layer_6
	this.instance_4 = new lib.Frame6();
	this.instance_4.setTransform(0,1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(225).to({_off:false},0).to({_off:true},46).wait(179));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(180).to({_off:false},0).to({_off:true},45).wait(225));

	// Layer_4
	this.instance_6 = new lib.Frame4();
	this.instance_6.setTransform(0,1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(134).to({_off:false},0).to({_off:true},46).wait(270));

	// Layer_3
	this.instance_7 = new lib.Frame3();
	this.instance_7.setTransform(0,1);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90).to({_off:false},0).to({_off:true},44).wait(316));

	// Layer_2
	this.instance_8 = new lib.Frame2();
	this.instance_8.setTransform(0,1);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(44).to({_off:false},0).to({_off:true},46).wait(360));

	// Layer_1
	this.instance_9 = new lib.Frame1();
	this.instance_9.setTransform(0,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true},44).wait(406));
...
// library properties:
lib.properties = {
	id: 'F98CFD628865AF488009B1FDD1BD6DF8',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Idea_Tab_Pro_Gen_2_CM_GDN_300x600_atlas_1.png", id:"PR_Idea_Tab_Pro_Gen_2_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['F98CFD628865AF488009B1FDD1BD6DF8'] = {
